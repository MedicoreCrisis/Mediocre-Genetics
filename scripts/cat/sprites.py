...
class Sprites():
    ...
    def load_all(self):
        ...
        for x in [
            'lineart', 'solidcolours', 'spottedcolours', 'braidedcolours',
            'whitepatches', 'eyes', 'eyes2', 'skin', 'scars', 'missingscars',
            'collars', 'bellcollars', 'bowcollars', 'nyloncollars',
            'rosettedcolours', 'marbledcolours', 'smokecolours', 'tickedcolours', 
            'mackerelcolours', 'classiccolours', 'brokenbraidedcolours', 'agouticolours', 'brokenmackerelcolours', 
        ...
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
            self.make_group('solidcolours', (a, 0), f'solid{i}')
        for a, i in enumerate(['CREAM', 'LILAC', 'FAWN', 'APRICOT', 'CARMBLUE', 'CARMLILAC', 'CARMFAWN']):
            self.make_group('solidcolours', (a, 1), f'solid{i}')
        for a, i in enumerate(['SILVER', 'SILVERBLUE', 'CAMEO', 'SILVERCHOCOLATE', 'SILVERCINNAMON', 'SILVERCREAM']):
            self.make_group('solidcolours', (a, 2), f'solid{i}')
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('solidcolours', (a, 3), f'solid{i}')
        # mackerel
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
        ...
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('mackerelcolours', (a, 3), f'mackerel{i}')
        # marbled
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
        ...
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('marbledcolours', (a, 3), f'marbled{i}')
        # smoke
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
        ...
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('smokecolours', (a, 3), f'smoke{i}')
        # ticked
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
        ...
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('tickedcolours', (a, 3), f'ticked{i}')
        # spotted
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
            self.make_group('spottedcolours', (a, 0), f'spotted{i}')
        for a, i in enumerate(['CREAM', 'LILAC', 'FAWN', 'APRICOT', 'CARMBLUE', 'CARMLILAC', 'CARMFAWN']):
            self.make_group('spottedcolours', (a, 1), f'spotted{i}')
        for a, i in enumerate(['SILVER', 'SILVERBLUE', 'CAMEO', 'SILVERCHOCOLATE', 'SILVERCINNAMON', 'SILVERCREAM']):
            self.make_group('spottedcolours', (a, 2), f'spotted{i}')
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('spottedcolours', (a, 3), f'spotted{i}')
        # rosetted
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
            self.make_group('rosettedcolours', (a, 0), f'rosetted{i}')
        for a, i in enumerate(['CREAM', 'LILAC', 'FAWN', 'APRICOT', 'CARMBLUE', 'CARMLILAC', 'CARMFAWN']):
            self.make_group('rosettedcolours', (a, 1), f'rosetted{i}')
        for a, i in enumerate(['SILVER', 'SILVERBLUE', 'CAMEO', 'SILVERCHOCOLATE', 'SILVERCINNAMON', 'SILVERCREAM']):
            self.make_group('rosettedcolours', (a, 2), f'rosetted{i}')
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('rosettedcolours', (a, 3), f'rosetted{i}')
        # classic
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
        ...
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('classiccolours', (a, 3), f'classic{i}')
        # agouti
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
        ...
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('agouticolours', (a, 3), f'agouti{i}')
        # brokenmackerel
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
        ...
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('brokenmackerelcolours', (a, 3), f'brokenmackerel{i}')
        # braided
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
        ...
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('braidedcolours', (a, 3), f'braided{i}')
        # brokenbraided
        for a, i in enumerate(['GHOST', 'BLACK', 'COLDBLUE', 'WARMBLUE', 'GINGER', 'HOTGINGER', 'CHOCOLATE', 'CINNAMON']):
        ...
        for a, i in enumerate(['SILVERLILAC', 'SILVERFAWN', 'SILVERAPRICOT', 'SILVERCARMBLUE', 'SILVERCARMLILAC', 'SILVERCARMFAWN']):
            self.make_group('brokenbraidedcolours', (a, 3), f'brokenbraided{i}')
